    ...
    <>
      ...
      <div className="listen-together-card freq-glass fade-in">
        ...
        <button 
          ...
          style={{
            marginTop: '15px', width: '100%', padding: '12px', background: 'var(--primary-accent)', color: '#000', border: 'none', borderRadius: '12px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px'
          }}
        >
